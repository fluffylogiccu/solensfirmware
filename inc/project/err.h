...
typedef enum esp8266_status_e {
    ...
    ESP8266_ERR_CONNACK = ERR,
    ESP8266_ERR_MALLOC = ERR+1,
    ESP8266_ERR_QUEUEFULL = ERR+2,
    ESP8266_ERR_QUEUEEMPTY = ERR+3,
    ESP8266_ERR_QUEUEPARTIAL = ERR+4,
    ESP8266_ERR_QUEUEINVALID = ERR+5,
    ESP8266_ERR_NULLPTR = ERR+6,
