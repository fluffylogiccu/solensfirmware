 ...
 *
 *  This register map was taken from the ArduCAM github
 *  at https://github.com/ArduCAM/Arduino.
 *
...

{
	...
	{0x5089 ,0x00},
	{0x302b ,0x00},
    //Here is where it sets it to the smaller image
	/*{0x3808 ,0x01},
	{0x3809 ,0x40},
	{0x380a ,0x00},
	{0x380b ,0xf0},*/
...
static const ov5642_reg_t OV5642_JPEG_Capture_QSXGA2[] =
{
	// OV5642_ QSXGA _YUV7.5 fps
	// 24 MHz input clock, 24Mhz pclk
	// jpeg mode 7.5fps
	{0x4403, 0x33}, //Compression CTRL 00
	{0x4500, 0x7E}, //JPEG CTRL
	{0x3503 ,0x07},	//AEC Manual Mode Control
	{0x3000 ,0x00},	//SYSTEM RESET00
	{0x3001 ,0x00},	//Reset for Individual Block
	{0x3002 ,0x00},	//Reset for Individual Block
